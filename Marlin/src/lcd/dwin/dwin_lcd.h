...
// Coordinate System
#define DWIN_LCD_COORD_LEFTMOST_X 0
#define DWIN_LCD_COORD_RIGHTMOST_X DWIN_WIDTH-1
...
// Draw Parameters for DWIN_Draw_IntValue
#define DWIN_LCD_DRAWINT_WITHOUT_BACKGROUND 0
#define DWIN_LCD_DRAWINT_WITH_BACKGROUND 1
#define DWIN_LCD_DRAWINT_WITHOUT_ZEROFILL 0
#define DWIN_LCD_DRAWINT_WITH_ZEROFILL 1
#define DWIN_LCD_DRAWINT_ZEROMODE_LEADING_SPACE 0
#define DWIN_LCD_DRAWINT_ZEROMODE_LEADING_ZERO 1
#define DWIN_LCD_DRAWINT_DIGITS 3
